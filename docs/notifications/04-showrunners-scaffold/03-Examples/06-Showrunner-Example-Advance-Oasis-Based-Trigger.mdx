---
id: docs-notifications-showrunners-examples-advance-protocol-based-trigger-oasis-protocol
title: Advance - Protocol based trigger (Oasis protocol)
hide_title: true
slug: ./advance-protocol-based-trigger-oasis-protocol
displayed_sidebar: pushNotificationSidebar
sidebar_position: 6
image: "/assets/docs/previews/docs_notifications_showrunners_examples_advance_protocol_based_trigger_oasis_protocol--advance_-_protocol_based_trigger_(oasis_protocol).png"
---
...
**GM!** Before going to the coding part directly, we used [MakerDAO ](https://docs.makerdao.com/)documentation for implementing [Oasis ](https://oasis.app/)channel.

<head>
  <title>
    {`Protocol based trigger (Oasis protocol liquidation example) | Example |
...
#### Adding [contarctAddress.json](#adding-contarctaddressjson-file) file
...
#### Adding [oasisChannel.ts](#adding-oasischannelts-file) file
...
#### Adding [oasisJobs.ts](#adding-oasisjobsts-file) file
...
#### Adding [oasisRoutes.ts](#adding-oasisroutests-file) file
