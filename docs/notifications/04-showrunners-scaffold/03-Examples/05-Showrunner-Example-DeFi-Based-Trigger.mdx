---
id: docs-notifications-showrunners-examples-defi-based-trigger
title: DeFi based trigger
hide_title: true
slug: ./defi-based-trigger
displayed_sidebar: pushNotificationSidebar
sidebar_position: 5
image: "/assets/docs/previews/docs_notifications_showrunners_examples--defi_based_trigger.png"
---
...
If you are new to Push protocol and don't have a proper idea of how to create a DEFI-based channel for notifications on top of [showrunners](/docs/notifications/showrunners-scaffold/get-started). This guide is for you ;)
...
You can access the [code](https://github.com/push-protocol/push-showrunners-framework-staging/tree/main/src/sample_showrunners/aave) for the channel and get some vibe for how the code is looking !!

<head>
  <title>
    {`DeFi based trigger | Example | Showrunners Scaffold | Push Notifications |
    Push Documentation`}
  </title>
</head>
...
- Contract Address for **AAVE Lending Pool** on the ethereum main-network : _`0x7d2768dE32b0b80b7a3454c06BdAc94A69DDc7A9`_
