...
Implement a webhook to listen to [AWS SNS](https://docs.aws.amazon.com/sdk-for-javascript/v2/developer-guide/sns-examples.html 'Example of AWS SNS'). Here’s a [boilerplate](https://github.com/push-protocol/push-sns-boilerplate 'Push SNS boilerplate repo') along with specs to get you npm installed and running.
...
Once you set up this, you need to contact us by either shouting / tagging us on [Push Discord server](https://discord.com/invite/pushchain 'Invite link to Push Discord server'). We need this as the SNS module requires whitelisting of your webhook endpoint.

## Push SNS Boilerplate

For your reference, here's [Push AWS SNS boilerplate](https://github.com/push-protocol/push-sns-boilerplate 'Push AWS SNS boilerplate') which can be used as a starting point to consume the feeds from the Push SNS Topic.
