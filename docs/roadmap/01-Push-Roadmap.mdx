...
This is a breaking change, we recommend all developers to join our [Discord server](https://discord.gg/pushprotocol) -> `#dev-announcements` channel for information on how to upgrade and best practices for easier transition.
