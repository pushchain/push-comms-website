...
function Bootcamp() {
  return (
    <Layout
      title={PageMeta.BOOTCAMP.pageTitle}
      description={PageMeta.BOOTCAMP.pageDescription}
      showNavbar={false}
    >
      <Head>
        {/* <!-- Facebook Meta Tags --> */}
        ...
        <meta
          name='og:description'
          content='BRB Bootcamp is the go-to place to learn every aspect of the web3 ecosystem from fundamentals to shipping your first project!'
        />
        <meta
          property='og:image'
          content={
            require('@site/static/assets/previews/bootcamppreview.png').default
          }
        />
        {/* <!-- Twitter Meta Tags --> */}
